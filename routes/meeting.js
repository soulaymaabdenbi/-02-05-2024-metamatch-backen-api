...
router.get('/stats/meetings/confirmation', meetingController.getMeetingsByConfirmationStatusStats);
router.get('/stats/meetings/month/:month', meetingController.getMeetingsByMonthStats);
